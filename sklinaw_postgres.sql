...
, rejection_reason TEXT NULL, approved_by TEXT NULL, approved_at DATETIME NULL);
CREATE TABLE IF NOT EXISTS Verified (
    Name TEXT NOT NULL,
    Barangay TEXT NOT NULL
);
INSERT INTO "Budget" ("barangay","total_budget","updated_at") VALUES ('Lahug',3957265.0,'2026-05-08 06:01:53'),
 ('Pajac',500000.0,'2026-05-08 08:34:46');
INSERT INTO "CommitteeBudget" ("barangay","committee_name","allocated_amount") VALUES ('Lahug','Health',360000.0),
...
INSERT INTO "CommitteeMembers" ("id","committee_name","barangay","councilor_name","joined_at") VALUES (1,'Health','Lahug','Diane Louise Torres','2026-05-07 11:23:17'),
...
INSERT INTO "Committees" ("name","barangay","head_name") VALUES ('Health','Lahug','Diane Louise Torres'),
...
INSERT INTO "Councilors" ("Name","Password","Barangay","approved","privilege") VALUES ('Maximus Limpag','$2a$10$UesBfMTwbo5i8a2.MBqG3.bImPg/sGjsr.QEaqn20ZQ47nlWcx2lO','Pajac',1,'CHAIRMAN'),
...
INSERT INTO "Developer" ("id","Name","Password","approved","privilege") VALUES (1,'Max Lennon Limpag','maxlennon123',1,'ADMIN'),
 (2,'Selena Malig','selena123',1,'ADMIN');
INSERT INTO "Feedback" ("id","barangay","name","message","rating","created_at","project_id") VALUES (1,'Lahug','Juan Dela Cruz','Great project! This will really help our community.',5,'2026-05-08 05:18:56',8),
...
INSERT INTO "PendingAccounts" ("Name","Password","Barangay","Photo") VALUES ('Jaden Zion Rosales','$2a$10$LH2WP2bABQd6nn2pJL7uWed35dlIMD8cIeS16fnBJmWolNKFsvaXW','Lahug','1778219706336_Screenshot 2026-03-21 013028.png');
INSERT INTO "ProjectRatings" ("project_id","barangay","average_rating","total_ratings","rating_1_count","rating_2_count","rating_3_count","rating_4_count","rating_5_count","updated_at") VALUES (11,'Lahug',3.0,2,0,1,0,1,0,'2026-05-08 08:55:45'),
 (14,'Lahug',3.66666666666667,3,1,0,0,0,2,'2026-05-08 08:22:22'),
 (18,'Pajac',5.0,1,0,0,0,0,1,'2026-05-08 08:44:40');
INSERT INTO "Projects" ("id","project_name","purpose","committee_name","barangay","councilor_name","total_cost","status","created_at","rejection_reason","approved_by","approved_at") VALUES (11,'Free anti-rabies vaccination','Distribute anti-rabies vaccinations in sitios with a higher than average case of rabies.','Health','Lahug','Diane Louise Torres',10000.0,'APPROVED','2026-05-08 06:40:35',NULL,'Ana Marie Fernandez','2026-05-08 07:13:21'),
